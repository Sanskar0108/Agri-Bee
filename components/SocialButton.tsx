...
export const SocialButton: React.FC<SocialButtonProps> = ({ provider, className = '', ...props }) => {
  ...
  return (
    <button
      className={`flex items-center justify-center w-full bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-xl shadow-md border border-gray-200 transition-all duration-200 mb-3 ${className}`}
      {...props}
    >
      {isGoogle ? (
